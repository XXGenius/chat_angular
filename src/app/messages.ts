export let responseMessage = [
  {
    id: 1,
    type: "text",
    text: "Привет. Для подбора косметики мне нужно определить ваш тип кожи и её особенности. Для этого вышлите свою фотографию и ответь на вопросы.Ваше имя:",
    field: "name"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    variants: [
      ...
      {
        text: "закрытые комедоны ( прыщи которые не воспаляются и никак не беспокоят, но чувствуются проводя по коже пальцами. Из-за этого кожа не ровная)",
        active: false
      },
      {
